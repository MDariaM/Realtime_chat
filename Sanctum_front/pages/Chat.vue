...
<div class="flex flex-row h-screen antialiased text-gray-800">
    <div class="flex flex-row w-96 flex-shrink-0 bg-purple-600 p-4">
    ...
    <div class="chat-box flex flex-col h-full w-full bg-white">
      <div class="flex flex-row w-full py-4 px-6  shadow bg-purple-600">
        ...
        <div class="flex flex-row items-center w-full border rounded-3xl h-12 px-2">
          ...
          <div class="w-full">
            <input 
              ...
              v-model="newMessage"
              type="text"
              class="border border-transparent w-full focus:outline-none relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl" 
...
<script>
  ...
  methods:{
    ...
    async sendMessage() {
      ...
      await this.$axios.$post('messages', {message:this.newMessage});
