...
<!-- <div class="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 flex-shrink-0" v-for= "(message, index1) in messages" :key="index1">
            ...
            <div class="col-start-1 col-end-8 p-3 rounded-lg">
              <ul class="flex flex-row items-center">
                <li v-for= "(message, index) in messages" :key="index">
                  ...
                  <p class="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl">{{ message.message }}</p>  
                    <div class="flex items-center justify-center h-10 w-10 rounded-full bg-indigo-500 flex-shrink-0" v-for= "(message, index1) in messages" :key="index1">
